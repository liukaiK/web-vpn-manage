    ...
    $.fn.bootstrapTreeTable = function(options, param) {
        ...
        var formatData = function(data) {
            ...
            $.each(data, function(index, item) {
                ...
                item.isShow = false;
                // 顶级节点校验判断，兼容0,'0','',null
                var _defaultRootFlag = item[options.parentCode] === '0' || item[options.parentCode] === 0 || item[options.parentCode] === null || item[options.parentCode] === '' || $.inArray(item[options.code], parentCodes) > 0 && !rootFlag;
